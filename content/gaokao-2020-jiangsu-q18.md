...
> **本课件目的**：用这道经典高考题测试 courseware 框架 v1.3.0 的 2D 组件能力——**能覆盖的部分做成交互，缺能力的部分如实标注**。
